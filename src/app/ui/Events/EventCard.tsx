...
export default function EventCard({ event, currentUser }: Props) {
  ...
  return (
    <article className="bg-white dark:bg-zinc-900 shadow-md dark:shadow-black/30 rounded-lg overflow-hidden border border-zinc-200 dark:border-zinc-700 transition-colors w-[80%] min-w-60">
