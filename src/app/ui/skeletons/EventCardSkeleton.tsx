      ...
      {[1, 2, 3].map((i) => (
        ...
        >
          ...
          <div className="p-4 space-y-3">
            ...
            <div className="h-3 bg-zinc-300 dark:bg-zinc-600 w-full rounded"></div>
            <div className="h-3 bg-zinc-300 dark:bg-zinc-600 w-2/3 rounded"></div>
            <div className="flex justify-between items-center">
              <div className="h-4 bg-zinc-300 dark:bg-zinc-600 w-1/3 rounded"></div>
